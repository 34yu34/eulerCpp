...
public:
    ...
    //////////////////////////////////////////////////////////////////////////
    // val setters
    Node & set_val(const T & val)
    {
      val_ = new T(val);return *this;
    };

    // next setters
    Node & set_next(Node * node)
    {
      next_ = node;node->last_ = this;return *this;
    }
    ...
    // last setters
    Node & set_last(Node * node)
    {
      last_ = node;node->next_ = this;return *this;
    }
...
public:
    ...
    Iterator & operator++()
    {
      node_ = &node_->get_next();return *this;
    };
    Iterator operator++(int)
    {
      Iterator it = Iterator(node_);node_ = &node_->get_next();return it;
    };
    ...
    Iterator & operator--()
    {
      node_ = &node_->get_last();return *this;
    };
    Iterator operator--(int)
    {
      Iterator it = Iterator(node_);node_ = &node_->get_last();return it;
    };
    Iterator operator-(int n) const
    {
      Iterator it = &this;
...
public:
  ...
  {
    return Iterator<T>(&begin_->get_next());
  }
  ...
  // Add an element at the end of the Enumerable
  Enumerable & operator<<(const T & val)
  {
    return push(val);
  }
  ...
  Enumerable operator+(const Enumerable & en) const
  {
    Enumerable out = *this;out += en;return en;
  }
  ...
  T sum()
  {
    return inject(T(), [] (const T & i, const T & j) {
      return i + j;
    });
  }
